        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    upolNumber = table.Column<string>(type: "text", nullable: true),
                    oborIdno = table.Column<int>(type: "integer", nullable: false),
                    rocnikRegistrace = table.Column<int>(type: "integer", nullable: false),
                    datumRegistrace = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kreditu = table.Column<int>(type: "integer", nullable: true),
                    rok = table.Column<string>(type: "text", nullable: true),
                    statut = table.Column<string>(type: "text", nullable: true),
                    doporucenyRocnik = table.Column<int>(type: "integer", nullable: true),
                    ...
                    oborIdNum = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
