...
namespace API.Data.Migrations
{
    ...
    [Migration("20211206114416_HodnoceniAccountName")]
    partial class HodnoceniAccountName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.SouborLike", b =>
                {
                    b.Property<int>("StudentId")
                        .HasColumnType("integer");

                    b.Property<int>("SouborId")
                        .HasColumnType("integer");

                    b.HasKey("StudentId", "SouborId");

                    b.HasIndex("SouborId");

                    b.ToTable("SouborLikes");
                });
            ...
            modelBuilder.Entity("API.Entities.SouborLike", b =>
                {
                    b.HasOne("API.Entities.Soubor", "Soubor")
                        .WithMany("StudentsLikedBy")
                        .HasForeignKey("SouborId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Student", "Student")
                        .WithMany("likedMaterialy")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
